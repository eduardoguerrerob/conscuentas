		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#egbcuentasui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"egbcuentasui5-display": {
								"semanticObject": "egbcuentasui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=egb.cuentasui5",
									"url": sap.ui.require.toUrl("egb/cuentasui5")
								}
							}
						}
					}
